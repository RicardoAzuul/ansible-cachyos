...
- Browsers and desktop apps: Firefox, Brave, Slack, VS Code, Teams, TickTick, Telegram, Steam, Signal, Obsidian, Discord, Espanso
- Developer tools: Git, Azure CLI, Terraform, Vagrant, rclone, pip
